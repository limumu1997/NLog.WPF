...
namespace NLog.WPF
{
    ...
    /// </summary>
    public partial class NlogListView : UserControl
    {
        public ListView LogView { get { return logView; } }

        public event EventHandler ItemAdded = delegate { };

        public ObservableCollection<NlogListViewModel> LogEntries { get; private set; }
        ...
        public NlogListView()
        {
            ...
            LogEntries = new ObservableCollection<NlogListViewModel>();
        ...
        {
            NlogListViewModel vm = new NlogListViewModel(log.LogEvent);
